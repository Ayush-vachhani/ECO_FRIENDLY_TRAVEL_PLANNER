...
<main class="p-6">
    ...
    <section class="mt-8 AboutSection">
        ...
        <div>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita perspiciatis assumenda omnis, eos tenetur laudantium culpa amet natus! Animi ratione error quisquam laborum labore enim in voluptatem nam sit libero!
        </div>
    </section>
            ...
            <section class="BenefitSection mt-8 bg-white">
                ...
                <div class="grid grid-cols-2">
                    <div class="flex items-center justify-center p-4 rounded border border-gray-300 bg-white">
                        <p class="text-center font-semibold p-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima ad voluptas illum? Illo itaque omnis hic dolores dolorem, iure eius dolor assumenda deleniti, enim sint, pariatur repudiandae eos sapiente accusamus.
                        Similique non sint quasi vel aut, voluptatem iure ipsam aspernatur, inventore sit fuga facilis ducimus ullam quibusdam atque, cupiditate aliquid blanditiis nisi praesentium dolore dignissimos sed debitis amet explicabo. Totam!</p>
                    </div>
                    
                    <div class="flex items-center justify-center grid grid-cols-2 gap-4 p-4">
                        <div class="group p-4 rounded border border-gray-300 bg-white transform hover:scale-105 transition duration-400">
            ...
            <section class="mt-8 Explore-section">
                ...
                <section class="mt-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="bg-white rounded-lg shadow-md p-6 bg-opacity-10 hover:bg-opacity-30 transform hover:scale-105 transition duration-300 hover:shadow-lg">
